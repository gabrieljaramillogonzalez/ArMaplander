package com.maplander.arlibmaplander.data.api
...
interface FoursquareAPI {
    ...
    @GET("search")
    fun searchVenues(@QueryMap params: Map<String, String>): Call<com.maplander.arlibmaplander.data.db.model.VenueWrapper>
}